...
This command **requires** the project directory as an argument via `/Users/justinbundrick/Documents/ALAESolutions/RIMSS/RIMSS-autocoder`.

**Example:** `/create-spec generations/my-app`

**Output location:** `/Users/justinbundrick/Documents/ALAESolutions/RIMSS/RIMSS-autocoder/prompts/app_spec.txt` and `/Users/justinbundrick/Documents/ALAESolutions/RIMSS/RIMSS-autocoder/prompts/initializer_prompt.md`

If `/Users/justinbundrick/Documents/ALAESolutions/RIMSS/RIMSS-autocoder` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `/Users/justinbundrick/Documents/ALAESolutions/RIMSS/RIMSS-autocoder/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `/Users/justinbundrick/Documents/ALAESolutions/RIMSS/RIMSS-autocoder/prompts/app_spec.txt`
...
**Output path:** `/Users/justinbundrick/Documents/ALAESolutions/RIMSS/RIMSS-autocoder/prompts/initializer_prompt.md`
...
**Output path:** `/Users/justinbundrick/Documents/ALAESolutions/RIMSS/RIMSS-autocoder/prompts/.spec_status.json`
...
> "Your specification files have been created in `/Users/justinbundrick/Documents/ALAESolutions/RIMSS/RIMSS-autocoder/prompts/`!
>
> **Files created:**
> - `/Users/justinbundrick/Documents/ALAESolutions/RIMSS/RIMSS-autocoder/prompts/app_spec.txt`
> - `/Users/justinbundrick/Documents/ALAESolutions/RIMSS/RIMSS-autocoder/prompts/initializer_prompt.md`
>
