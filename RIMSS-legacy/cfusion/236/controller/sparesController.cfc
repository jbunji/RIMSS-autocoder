...
component hint="Controller for spares processes" output="false" extends="cfc.utils.Proxy"
{
    ...
    public any function searchSpares( string sparesCriteria= ""){
        ...
        getJavaLoggerProxy().fine(message="Querying Spares dbUtils.getSpares1(#getSessionFacade().getProgramSetting()#,#ARGUMENTS.sparesCriteria#)",sourceClass=getUtilities().getComponentName(this), methodName="searchSpares");
