...
<RIMMS:layout layout="236">
    ...
    <script type="text/javascript" src="<cfoutput>#application.rootpath#</cfoutput>/236/layout/js/maintenance.js"></script>
    ...
    <div class="font12 mainContent">
        <cfform id="createMaintenance" name="createMaintenance" method="post" action="index.cfm">
            ...
            <input type="hidden" id="partno" name="partno" value="<cfif StructKeyExists(form, 'partno')><cfoutput>#HTMLEditFormat(trim(form.partno))#</cfoutput></cfif>" />
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="column">
                                ...
                                <div class="formField action_taken">
