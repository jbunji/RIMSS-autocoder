			...
			<cfscript>
				if ( IsDefined('arguments.path') and arguments.path neq '' ) {
					...
					}else
					{
						...
						// bug 3646333, we should use create object here instead of directly using TemplateProxy. This is because, CreateObject does a proper check on type of file ( non component) being loaded as component.
						comp = CreateObject("component", HTMLEditFormat(newpath) );
					}
				} else {
