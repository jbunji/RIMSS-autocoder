...
this.open=function(_3ef,_3f0){
if(self.WebSocket||self.MozWebSocket){
if(!this.wsConnection){
var _3f1=this;
if("MozWebSocket" in window){
this.wsConnection=new MozWebSocket(_3ef,"json");
}else{
this.wsConnection=new WebSocket(_3ef);
}
this.wsConnection.connectionOptions=_3f0;
this.onWelcome=_3f0.OnWelcome;
this.wsConnection.onopen=function(_3f2){
if(_3f0.OnWelcome){
_3f0.OnWelcome(_3f1);
}
};
this.wsConnection.onmessage=function(_3f3){
var _3f4=_3f1.streamToToken(_3f3.data);
if(_3f4.code&&_3f0.onError&&(_3f4.code==cf_ws.APP_ERROR_CODE||_3f4.code==cf_ws.CHANNEL_ERROR_CODE)){
_3f0.onError(_3f4,_3f1);
}else{
if(_3f0.OnMessage){
if(_3f4.data){
if(cf_ws.validRE.test(_3f4.data)){
_3f4.data=_3f1.streamToToken(_3f4.data);
}
}
_3f0.OnMessage(_3f4,_3f1);
}
}
};
this.wsConnection.onclose=function(_3f5){
...
this.wsConnection.onerror=function(_3f6){
this.wsConnection.readyState=cf_ws.CLOSED;
if(_3f0.onError){
_3f0.onError(null,_3f1);
}
};
}
}else{
...
},this.sendStream=function(_3f7){
if(this.wsConnection&&this.wsConnection.readyState==cf_ws.OPEN){
this.wsConnection.send(_3f7);
}else{
throw new Error("Connection not established.");
}
},this.isConnected=function(){
return (this.wsConnection!=null&&this.wsConnection.readyState==cf_ws.OPEN);
},this.forceClose=function(_3f8){
},this.close=function(_3f9){
if(this.wsConnection){
...
},this.checkCallbacks=function(_3fa){
var _3fb="utid"+_3fa.utid;
},this.createDefaultResult=function(){
return {code:0,msg:"Ok",localeKey:"jws.jsc.res.Ok",args:null,tid:jws.CUR_TOKEN_ID};
},this.tokenToStream=function(_3fc){
return ColdFusion.JSON.encode(_3fc);
...
},this.processResponsePacket=function(_3fe){
var _3ff=ColdFusion.JSON.decode(_3fe.data);
if(_3ff.type){
if(_3ff.type=="welcome"&&_3ff.usid){
this.fSessionId=_3ff.usid;
this.fClientId=_3ff.sourceId;
if(this.fOnWelcome){
this.fOnWelcome(_3ff);
}
}else{
if(_3ff.type=="goodBye"){
if(this.fOnGoodBye){
this.fOnGoodBye(_3ff);
}
...
if(_3ff.type=="response"){
this.checkCallbacks(_3ff);
}else{
...
},this.sendToken=function(_400){
if(this.isConnected()){
var _401=ColdFusion.JSON.encode(_400);
this.wsConnection.send(_401);
}else{
throw new Error("Connection not established.");
}
},this.startKeepAlive=function(_402){
...
_48c.error("Flash Player >= 10.0.0 is required.");
return;
}
if(location.protocol=="file:"){
_48c.error("WARNING: web-socket-js doesn't work in file:///... URL "+"unless you set Flash Security Settings properly. "+"Open the page via Web server i.e. http://...");
}
window.WebSocket=function(url,_48e,_48f,_490,_491){
var self=this;
...
WebSocket.__flash.create(self.__id,url,_48e,_48f||null,_490||0,_491||null,_cf_flash_policy_port||1243);
});
},0);
};
...
var _494=WebSocket.__flash.send(this.__id,encodeURIComponent(data));
if(_494<0){
return true;
}else{
this.bufferedAmount+=_494;
return false;
}
};
...
WebSocket.prototype.addEventListener=function(type,_496,_497){
if(!(type in this.__events)){
this.__events[type]=[];
}
this.__events[type].push(_496);
};
WebSocket.prototype.removeEventListener=function(type,_499,_49a){
if(!(type in this.__events)){
return;
}
var _49b=this.__events[type];
for(var i=_49b.length-1;i>=0;--i){
if(_49b[i]===_499){
_49b.splice(i,1);
break;
}
...
WebSocket.prototype.dispatchEvent=function(_49d){
var _49e=this.__events[_49d.type]||[];
for(var i=0;i<_49e.length;++i){
_49e[i](_49d);
}
var _4a0=this["on"+_49d.type];
if(_4a0){
_4a0.apply(this,[_49d]);
}
};
WebSocket.prototype.__handleEvent=function(_4a1){
if("readyState" in _4a1){
this.readyState=_4a1.readyState;
}
if("protocol" in _4a1){
this.protocol=_4a1.protocol;
}
var _4a2;
if(_4a1.type=="open"||_4a1.type=="error"){
_4a2=this.__createSimpleEvent(_4a1.type);
}else{
if(_4a1.type=="close"){
_4a2=this.__createSimpleEvent("close");
_4a2.wasClean=_4a1.wasClean?true:false;
_4a2.code=_4a1.code;
_4a2.reason=_4a1.reason;
}else{
if(_4a1.type=="message"){
var data=decodeURIComponent(_4a1.message);
_4a2=this.__createMessageEvent("message",data);
}else{
throw "unknown event type: "+_4a1.type;
}
}
}
this.dispatchEvent(_4a2);
};
WebSocket.prototype.__createSimpleEvent=function(type){
if(document.createEvent&&window.Event){
var _4a5=document.createEvent("Event");
_4a5.initEvent(type,false,false);
return _4a5;
}else{
...
var _4a8=document.createEvent("MessageEvent");
_4a8.initMessageEvent("message",false,false,data,null,null,window,null);
return _4a8;
}else{
...
_48c.error("[WebSocket] set WEB_SOCKET_SWF_LOCATION to location of WebSocketMain.swf");
return;
}
...
var _4aa=RegExp.$1;
if(location.host!=_4aa){
_48c.error("[WebSocket] You must host HTML and WebSocketMain.swf in the same host "+"('"+location.host+"' != '"+_4aa+"'). "+"See also 'How to host HTML file and SWF file in different domains' section "+"in README.md. If you use WebSocketMainInsecure.swf, you can suppress this message "+"by WEB_SOCKET_SUPPRESS_CROSS_DOMAIN_SWF_ERROR = true;");
}
}
var _4ab=document.createElement("div");
_4ab.id="webSocketContainer";
_4ab.style.position="absolute";
if(WebSocket.__isFlashLite()){
_4ab.style.left="0px";
_4ab.style.top="0px";
}else{
_4ab.style.left="-100px";
_4ab.style.top="-100px";
}
var _4ac=document.createElement("div");
_4ac.id="webSocketFlash";
_4ab.appendChild(_4ac);
document.body.appendChild(_4ab);
...
if(!e.success){
_48c.error("[WebSocket] swfobject.embedSWF failed");
}
});
};
...
setTimeout(function(){
try{
var _4af=WebSocket.__flash.receiveEvents();
for(var i=0;i<_4af.length;++i){
WebSocket.__instances[_4af[i].webSocketId].__handleEvent(_4af[i]);
}
}
catch(e){
_48c.error(e);
...
WebSocket.__log=function(_4b1){
_48c.log(decodeURIComponent(_4b1));
};
WebSocket.__error=function(_4b2){
_48c.error(decodeURIComponent(_4b2));
};
...
var _4b4=window.navigator.mimeTypes["application/x-shockwave-flash"];
if(!_4b4||!_4b4.enabledPlugin||!_4b4.enabledPlugin.filename){
return false;
}
return _4b4.enabledPlugin.filename.match(/flashlite/i)?true:false;
};
...
return escapable.test(_4b9)?"\""+_4b9.replace(escapable,function(a){
var c=meta[a];
return typeof c==="string"?c:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4);
})+"\"":"\""+_4b9+"\"";
}
function str(key,_4bd){
var i,k,v,length,mind=gap,partial,value=_4bd[key];
if(value&&typeof value==="object"&&typeof value.toJSON==="function"){
value=value.toJSON(key);
}
if(typeof rep==="function"){
value=rep.call(_4bd,key,value);
}
switch(typeof value){
case "string":
return quote(value);
...
JSON.stringify=function(_4bf,_4c0,_4c1){
var i;
gap="";
indent="";
if(typeof _4c1==="number"){
for(i=0;i<_4c1;i+=1){
indent+=" ";
}
}else{
...
rep=_4c0;
if(_4c0&&typeof _4c0!=="function"&&(typeof _4c0!=="object"||typeof _4c0.length!=="number")){
...
JSON.parse=function(text,_4c4){
var j;
function walk(_4c6,key){
var k,v,value=_4c6[key];
...
return _4c4.call(_4c6,key,value);
}
text=String(text);
cx.lastIndex=0;
if(cx.test(text)){
...
j=eval("("+text+")");
return typeof _4c4==="function"?walk({"":j},""):j;
}
throw new SyntaxError("JSON.parse");
};
}
}());
var Base64={_keyStr:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",encode:function(_4ca){
var _4cb="";
var chr1,chr2,chr3,enc1,enc2,enc3,enc4;
var i=0;
_4ca=Base64._utf8_encode(_4ca);
while(i<_4ca.length){
chr1=_4ca.charCodeAt(i++);
chr2=_4ca.charCodeAt(i++);
chr3=_4ca.charCodeAt(i++);
enc1=chr1>>2;
...
_4cb=_4cb+this._keyStr.charAt(enc1)+this._keyStr.charAt(enc2)+this._keyStr.charAt(enc3)+this._keyStr.charAt(enc4);
}
return _4cb;
},decode:function(_4ce){
var _4cf="";
var chr1,chr2,chr3;
var enc1,enc2,enc3,enc4;
var i=0;
_4ce=_4ce.replace(/[^A-Za-z0-9\+\/\=]/g,"");
while(i<_4ce.length){
enc1=this._keyStr.indexOf(_4ce.charAt(i++));
enc2=this._keyStr.indexOf(_4ce.charAt(i++));
enc3=this._keyStr.indexOf(_4ce.charAt(i++));
enc4=this._keyStr.indexOf(_4ce.charAt(i++));
chr1=(enc1<<2)|(enc2>>4);
chr2=((enc2&15)<<4)|(enc3>>2);
chr3=((enc3&3)<<6)|enc4;
_4cf=_4cf+String.fromCharCode(chr1);
if(enc3!=64){
_4cf=_4cf+String.fromCharCode(chr2);
}
if(enc4!=64){
_4cf=_4cf+String.fromCharCode(chr3);
}
}
_4cf=Base64._utf8_decode(_4cf);
return _4cf;
},_utf8_encode:function(_4d3){
_4d3=_4d3.replace(/\r\n/g,"\n");
var _4d4="";
