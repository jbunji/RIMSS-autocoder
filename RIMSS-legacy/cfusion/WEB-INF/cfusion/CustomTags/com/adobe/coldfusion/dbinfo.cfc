 ...
 * procedures, foreign keys, indexes, clientinfo and version information about the database, driver, and JDBC.
 * @name dbinfo
...
component extends="base"
{
	...
	/**
	 * Retrieve client information properties
	 * @return query with clientinfo 
	 * @output false
	 */
	public query function clientinfo()
	{
		return invoketag(arguments,"clientinfo");	
	}
    ...
    public query function invoketag(struct attribs,string type)
	{
		...
		// we need to remove it because clientinfo is an attribute as well as a possible value for type (dbinfo extends querytag )
		structdelete(tagAttributes,"clientinfo");
