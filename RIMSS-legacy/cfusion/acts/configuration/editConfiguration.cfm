...
<RIMSS:layout section="configuration">
	...
	<div class="mainContent">
		...
		<table class="three_column_table" cellpadding="0px" cellspacing="0px" style="">
					      			...
					      			<tr>
					         			<td>&nbsp;
											<label class="font10">
												...
												<a target="_blank" href="#application.rootpath#/RIMSS/#application.sessionManager.getUserName()#/#encodeForURL(rc.qAttachments.name)#"> #IIF(rc.qAttachments.name NEQ "", DE('#rc.qAttachments.name#'), DE('#rc.qAttachments.attId#'))# - View</a>
											</label>
											<a href="index.cfm?action=edit.configuration&assetid=#encodeForURL(rc.util.encryptId(rc.assetObj.getAssetID()))#&attId=#encodeForURL(rc.qAttachments.attId)#">Delete</a>
										</td>
			...
			<tr>
				<td class="column" style="text-align:right"><cfoutput><a href="index.cfm?action=new.configuration&assetid=#encodeForURL(rc.util.encryptId(rc.assetObj.getAssetID()))#">Add New Sys Config</a></cfoutput></td>
				
				
				<cfoutput>
				<cfif StructKeyExists(rc,'codeObj') and rc.codeObj.getCodeValue() EQ 'POD'>
					<td class="column" style="text-align:right"><cfoutput><a href="index.cfm?action=list.configuration&assetid=#encodeForURL(rc.util.encryptId(rc.nhaassetObj.getAssetID()))#">Return to System Config List</a></cfoutput></td>	
				<cfelse>
					<td class="column" style="text-align:right"><cfoutput><a href="index.cfm?action=edit.configuration.sub&assetid=#encodeForURL(rc.util.encryptId(rc.nhaassetObj.getAssetID()))#">Return to Edit Config</a></cfoutput></td>
				</cfif>				
				</cfoutput>
			</tr>
			</tbody>	
				...
				<table class="one_column_table" cellpadding="0px" cellspacing="0px">
                	<tbody>
						...
						<tr>
							...
							<td>
					            <div class="font10">
					             <table class="globalSubTable" id="sraTable">
									<thead>
									<tr>
										<th>Noun</th>
										<th>NSN</th>
