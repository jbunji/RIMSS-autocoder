﻿<cfsilent>
    ...
    <cfscript>
        ...
        import acts.controller.maintenanceUIDController;
        import acts.controller.sortieController;
        import acts.controller.notificationsController;
            ...
            try{
                ...
                switch(lcase(trim(ARGUMENTS.action))){
					...
					case 'new.configuration': {
                    	...
                    	param name="request.context.configSet" default="0";
                    	...
                    	local.configController.newConfig(request.context.assetid,request.context.configSet);
                    break;
                    }
                    ...
                    case 'create.configuration': {
                    	...
                    	local.configController.updateConfig(request.context.assetid,request.context.nhaassetid,request.context.sranoun,Duplicate(Form));
                    break;
                    }
                    ...
                    case 'edit.configuration': {
                    	param name="request.context.assetid" default="0";
                    	param name="request.context.nhaassetid" default="0";
                    	param name="request.context.attId" default="0";
                    	...
                    	local.x = local.configController.editConfig(request.context.assetid,request.context.attId);
                    break;
                    }
                    ...
                    case 'edit.configuration.sub': {
                    	...
                    	local.configController = new configurationController();
                    	getJavaLoggerProxy().fine(message="Sending to configController.editConfig()",sourceClass=local.utils.getComponentName(this), methodName="forward");
                    	local.x = local.configController.editSubConfig(request.context.assetid,request.context.attId);
                    break;
                    }
                    ...
                    case 'add.configuration.sub': {
                    	...
                    	local.configController = new configurationController();
                    	getJavaLoggerProxy().fine(message="Sending to configController.editConfig()",sourceClass=local.utils.getComponentName(this), methodName="forward");
                    	local.x = local.configController.addSubConfig(request.context.assetid,request.context.configSet);
                    break;
                    }                
                    ...
                    case 'update.sra': {
                        ...
                        param name="request.context.attId" default="0";  
                        local.configurationController= new configurationController();
                        local.configurationController.moveConfig(form.assetid,form.newassetid,Duplicate(Form),request.context.attId);
