...
if(url.action == 'exportp5'){
	...
	session.p5.kgserno = form.kgserno;
	session.p5.lru = form.lru;
	session.p5.oob = form.oob;
	session.p5.pqdr = form.pqdr;
	if(Structkeyexists(form,"adiu_1")){
		session.p5.adiu_1 = 1;
	}
	else{
		session.p5.adiu_1 = 0;
	}
	if(Structkeyexists(form,"adiu_2")){
		session.p5.adiu_2 = 1;
	}
	else{
		session.p5.adiu_2 = 0;
	}
	if(Structkeyexists(form,"adiu_3")){	
		session.p5.adiu_3 = 1;
	}
	else{
		session.p5.adiu_3 = 0;
	}
	if(Structkeyexists(form,"adiu_4")){
		session.p5.adiu_4 = 1;
	}
	else{
		session.p5.adiu_4 = 0;
	}
	if(Structkeyexists(form,"adiu_5")){
		session.p5.adiu_5 = 1;
	}
	else{
		session.p5.adiu_5 = 0;
	}
	if(Structkeyexists(form,"adiu_6")){
		session.p5.adiu_6 = 1;
	}
	else{
		session.p5.adiu_6 = 0;
	}
	if(Structkeyexists(form,"adiu_7")){
		session.p5.adiu_7 = 1;
	}
	else{
		session.p5.adiu_7 = 0;
