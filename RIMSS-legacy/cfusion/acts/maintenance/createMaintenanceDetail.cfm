...
<RIMMS:layout layout="acts">
    ...
    <div class="font12 mainContent">
        <cfform id="createMaintenance" name="createMaintenance" method="post" action="index.cfm">
			...
			<input type="hidden" name="bitPcId" readonly="readonly" id="bitPcId" <cfif Structkeyexists(form,"bitPcId")>value="#HtmlEditFormat(trim(form.bitPcId))#"</cfif>/>	
			...
			<div class="formContent">
                <table class="one_column_table" cellpadding="0px" cellspacing="0px">
                    <tbody>
                        <tr><td class="section_header">JOB ID: <cfif StructKeyExists(form, 'jobId')><cfoutput>#HTMLEditFormat(trim(form.jobId))#</cfoutput></cfif> | SERNO: <span id="nhaSerno"><cfif StructKeyExists(form, 'serno')><cfoutput>#HTMLEditFormat(trim(form.serno))#</cfoutput></cfif></span> | PARTNO: <span id="partno"><cfif StructKeyExists(form, 'partno')><cfoutput>#HTMLEditFormat(trim(form.partno))#</cfoutput></cfif></span></td></tr>
                    </tbody>
                </table>
                <table class="one_column_table" cellpadding="0px" cellspacing="0px">
                    <tbody>
                        <tr>
                            <td class="column">
                                <div class="formField">
                                    <label class="font10" id="repair_seq_label"><span class="font10 required_field">&nbsp;</span>SEQ: <cfoutput>#HTMLEditFormat(trim(form.seq))#</cfoutput></label>
							...
							<td class="column">
								...
								<div class="formField">
									<cfif StructKeyExists(form, 'repairStartDate')>
										<cfset variables.repairStart = HTMLEditFormat(trim(form.repairStartDate))>
									<cfelse>
										<cfset variables.repairStart = Dateformat(NOW(),"DD-MMM-YYYY")>
									</cfif>
									<cfif StructKeyExists(form, 'repairStartTime')>
										<cfset variables.repairStartTime = HTMLEditFormat(trim(form.repairStartTime))>
									<cfelse>
                ...
                <td colspan="3" class="column">
                  <div class="columnContent">
                            <div class="formField">
                                ...
                                <div id="bitPcContainer1">
									<label class="font10" id="nsn_label">Add Bit Pieces:</label> 
	                                <cfoutput>
	                                <span style="display:inline-block;">
	                                    <a href="#application.rootpath#/dialogs/lookupBitPcDialog.cfm" class="lookup" id="bitpc_lookup_ref"><img id="lookup_img" src="#application.rootpath#/common/images/lookup.png" /></a>
	                                </span> 
	                                </cfoutput><br><br> 
	                            </div>
	                            <div id="bitPcContainer">
	                            </div>                                                        
                                
<!---                                <div id="bitPcContainer2">
                                	<cfif rc.qLaborBitPc.recordcount GT 0>
                                	<label class="font10" id="nsn_label">Edit Bit Pieces:</label> 
                        ...
                        <tr>
                            <td>
                                <div class="button_container">
                                    ...
                                    <input type="submit" class="input_buttons font10" id="btnInsert" name="btnInsert" value="INSERT" onclick="setAction('insert.eventDetail',this);setMethod('doAction',this);" />
