...
<cfsilent>
	...
	<cfset ATTRIBUTES.program = #lcase(session.user.settings.program)#/>
    ...
    <cfif (IsDefined("userModel")) >
    	<cfif session.user.settings.program NEQ "236">
...
<html>
	<head>
        ...
        <!---<script src="#application.rootpath#/common/js/jquery-1.9.1.js"></script>--->
		<script src="#application.rootpath#/common/js/jquery-ui-1.9.1.js"></script>
		<!---<script src="#application.rootpath#/common/js/jquery-ui.min-1.12.1.js"></script>--->
		...
		<!---<script src="#application.rootpath#/common/layout/js/bootstrap.min.js"></script>--->
                                    ...
                                    <div id="application_menu">
                                        <cfif isDefined("programPath") and len(trim(programPath))>
                                            <ul id="menulist">
                                                ...
                                                <cfif showReports>
                                                  <li id="menuReports" class="parent"><a href="/ReportsGen2/RIMSS/index.cfm?pgm=<cfoutput>#programInSession#</cfoutput>">REPORTS</a></li>
                                                </cfif>
                                                <cfif showSorties>
                                                ...
                                                <cfif ATTRIBUTES.showAdmin>
                                                	<li id="menuAdmin" class="parent"><a href="##">ADMIN</a>
                                                		<ul>
                                                			<li><div>
                                                				<a href="/RIMSS/admin/adhoc/index.cfm">Ad-Hoc</a>	
                                                			</div></li>
                                                			<cfif StructKeyExists(attributes, "program") and attributes.program EQ 'acts'>
	                                                			<li><div>
	                                                				<a href="/RIMSS/admin/config/index.cfm">Edit BOM</a>	
	                                                			</div></li>
                                                			</cfif>
                                	...
                                	<nav class="navbar navbar-default">
									  <div class="container-fluid">
									    ...
									    <div class="collapse navbar-collapse" >
									      <ul id="menulist" class="nav nav-tabs nav-justified">
									        <cfif showMaintenance>
                                              <li id="menuMaint" class="menuItem"><a href="<cfoutput>#programPath#</cfoutput>/maintenance/backlog.cfm">MAINTENANCE</a></li>
                                            </cfif>
                                            <cfif showConfig>
                                              <li id="menuConfig" class="menuItem"><a href="<cfoutput>#programPath#</cfoutput>/configuration/configuration.cfm">CONFIGURATION</a></li>
                                            </cfif>
                                            <cfif showReports>
                                              <li id="menuReports" class="menuItem"><a href="/ReportsGen2/RIMSS/index.cfm?pgm=<cfoutput>#programInSession#</cfoutput>">REPORTS</a></li>
                                            </cfif>
                                            <cfif showSorties>
                                              <li id="menuSortie" class="menuItem"><a href="<cfoutput>#programPath#</cfoutput>/sortie/sortieSearch.cfm">SORTIES</a></li>
                                            </cfif>
											<cfif showSpares>
                                              <li id="menuSpares" class="menuItem"><a href="<cfoutput>#programPath#</cfoutput>/spares/spares.cfm">SPARES</a></li>
                                            </cfif>
                                            <cfif showInventory>
                                              <li id="menuInventory" class="menuItem"><a href="<cfoutput>#programPath#</cfoutput>/inventory/inventory.cfm">INVENTORY</a></li>
                                            </cfif>
                                                
                                                
									        
									        
									        <li id="menuAdmin" class="dropdown">
									          <a href="##" class="dropdown-toggle menuItem" data-toggle="dropdown">ADMIN <span class="caret"></span></a>
									          <ul class="dropdown-menu">
									            <li class="menuItem"><a href="/RIMSS/admin/adhoc/index.cfm">Ad-Hoc</a></li>
