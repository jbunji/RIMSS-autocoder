...
<RIMMS:layout layout="criis">
	...
	<script type="text/javascript" >
		...
		$(function() {
		 ...
		 function maintCompDateOnChange(){
		 	...
		 	setTimeout(function(){ //alert("Hello document is ready...."); 
			    		//var jobcompdt = document.getElementById('maintCompDate').value;
			    		var jobcompdt = document.getElementById('maintCompDate').value;
					 	if(jobcompdt.length > 0){
					 		document.getElementById("clearDate_png").style.visibility = "visible";
    ...
    <div class="headerContent">
    	<div class="headerTitle">Create Maintenance <cfoutput>#application.sessionManager.getMaintLevelSetting()#</cfoutput></div>
    </div>
						...
						<tr>
								...
								<div class="columnContent">
									...
									<cfif application.sessionManager.getSubSection() EQ 'AIRBORNE'>
	                                    <div class="formField etmClass">
	                                        <label class="font10" id="etm_start_label"><span class="font10 required_field">*</span>CPOT START:</label> 
                            ...
                            <td class="column">
                                <div class="columnContent">
									...
									<cfif application.sessionManager.getSubSection() EQ 'AIRBORNE'>
	                                    <div class="formField etmClass">
	                                        <label class="font10" id="etm_comp_label"><span class="font10 required_field">&nbsp;</span>CPOT COMP:</label> 
                                    ...
                                    <div class="formField">
			                            ...
			                            <input class="form_field font10 calendar_field" onkeypress="maintCompDateOnKey();" onkeyup="maintCompDateOnKey();" onfocus="maintCompDateOnChange();" id="maintCompDate" type="text" name="maintCompDate" value="<cfif StructKeyExists(form, 'maintCompDate')><cfoutput>#encodeForHTML(trim(form.maintCompDate))#</cfoutput></cfif>" readonly="readonly" />
