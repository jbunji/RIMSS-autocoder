...
<cfparam name="typeMaint" default="" />
<RIMMS:layout layout="criis">
    ...
    <div class="headerContent">
        <div class="headerTitle">Create Maintenance Detail</div>
    </div>
    <div class="font12 mainContent">
        <cfform id="createMaintenance" name="createMaintenance" method="post" action="index.cfm">
            ...
            <input type="hidden" id="partno" name="partno" value="<cfif StructKeyExists(form, 'nhaPartno')><cfoutput>#encodeForHTML(trim(form.partno))#</cfoutput><cfelse><cfoutput>#encodeForHTML(trim(form.partno))#</cfoutput></cfif>" />
			<input type="hidden" id="partnoId" name="partnoId" value="<cfif StructKeyExists(form, 'partnoId')><cfoutput>#encodeForHTML(trim(form.partnoId))#</cfoutput></cfif>" />
            <input type="hidden" id="wucCd" name="wucCd" value="<cfif StructKeyExists(form, 'wucCd')><cfoutput>#encodeForHTML(trim(form.wucCd))#</cfoutput></cfif>">
			<input type="hidden" name="cumHrs" id="cumHrs" value="<cfif StructKeyExists(form, 'cumHrs')><cfoutput>#encodeForHTML(trim(form.cumHrs))#</cfoutput></cfif>">
			<div class="formContent">
                <table class="one_column_table" cellpadding="0px" cellspacing="0px">
                    <tbody>
                        <tr><td class="section_header">JOB ID: <cfif StructKeyExists(form, 'jobId')><cfoutput>#encodeForHTML(trim(form.jobId))#</cfoutput></cfif> | SERNO: <span id="nhaSerno"><cfif StructKeyExists(form, 'serno')><cfoutput>#encodeForHTML(trim(form.serno))#</cfoutput></cfif></span> | PARTNO: <span id="partno"><cfif StructKeyExists(form, 'partno')><cfoutput>#encodeForHTML(trim(form.partno))#</cfoutput></cfif></span></td></tr>
                    </tbody>
                </table>
                <table class="one_column_table" cellpadding="0px" cellspacing="0px">
                    <tbody>
                        <tr>
                            <td class="column">
                                <div class="formField">
                                    <label class="font10" id="repair_seq_label"><span class="font10 required_field">&nbsp;</span>SEQ: <cfoutput>#encodeForHTML(trim(form.seq))#</cfoutput></label>
									<input type="hidden" id="seq" name="seq" value="<cfoutput>#encodeForHTML(trim(form.seq))#</cfoutput>" />
                                </div>
                            </td>
						</tr>
                    </tbody>
                        ...
                        <tr>
                        	<td class="column">
                        		<div class="formField">
                                    ...
                                    <input type="hidden" id="typeMaintCodeId" name="typeMaintCodeId" value="<cfif StructKeyExists(form, 'typeMaintCodeId')><cfoutput>#encodeForHTML(trim(form.typeMaintCodeId))#</cfoutput></cfif>" />
                                    <input class="form_field font10" id="typeMaint" type="text" name="typeMaint" value="<cfif StructKeyExists(form, 'typeMaint')><cfoutput>#encodeForHTML(trim(form.typeMaint))#</cfoutput></cfif>" readonly="readonly" style="min-width: 50%;" />
                                ...
                                <div class="formField">
                                    ...
                                    <input type="hidden" id="howMalCodeId" name="howMalCodeId" value="<cfif StructKeyExists(form, 'howMalCodeId')><cfoutput>#encodeForHTML(trim(form.howMalCodeId))#</cfoutput></cfif>" />
                                    <input class="form_field font10" id="howMal" type="text" name="howMal" value="<cfif StructKeyExists(form, 'howMal')><cfoutput>#encodeForHTML(trim(form.howMal))#</cfoutput></cfif>" readonly="readonly" style="min-width: 50%;" />
                            ...
                            <td class="column">
                                <div class="formField when_disc" style="display:none">
                                    ...
                                    <input type="hidden" id="whenDiscCodeId" name="whenDiscCodeId" value="<cfif StructKeyExists(form, 'whenDiscCodeId')><cfoutput>#encodeForHTML(trim(form.whenDiscCodeId))#</cfoutput></cfif>" />
                                    <input class="form_field font10" id="whenDisc" type="text" name="whenDisc" value="<cfif StructKeyExists(form, 'whenDisc')><cfoutput>#encodeForHTML(trim(form.whenDisc))#</cfoutput></cfif>" readonly="readonly" style="min-width: 50%;" />
                                ...
                                <div class="formField action_taken" style="display:none">
                                    ...
                                    <input type="hidden" id="actionTknCodeId" name="actionTknCodeId" value="<cfif StructKeyExists(form, 'actionTknCodeId')><cfoutput>#encodeForHTML(trim(form.actionTknCodeId))#</cfoutput></cfif>" />
                                    <input class="form_field font10" id="actionTkn" type="text" name="actionTkn" value="<cfif StructKeyExists(form, 'actionTkn')><cfoutput>#encodeForHTML(trim(form.actionTkn))#</cfoutput></cfif>" readonly="readonly" style="min-width: 50%;" />
					...
					<tbody>
						<tr>
							<td class="column">
								...
								<div class="formField">
									<cfif StructKeyExists(form, 'repairStartDate')>
										<cfset variables.repairStart = encodeForHTML(trim(form.repairStartDate))>
									<cfelse>
										<cfset variables.repairStart = Dateformat(NOW(),"DD-MMM-YYYY")>
									</cfif>
									<cfif StructKeyExists(form, 'repairStartTime')>
										<cfset variables.repairStartTime = encodeForHTML(trim(form.repairStartTime))>
									<cfelse>
										<cfset variables.repairStartTime = Timeformat(NOW(),"HH:nn")>
									</cfif>										
									<label class="font10" id="repair_start_label">&nbsp;REPAIR START:</label> 
                                    <input class="form_field font10 calendar_field" type="text" id="repairStartDate" name="repairStartDate" value="<cfoutput>#variables.repairStart#</cfoutput>"  readonly="readonly" />
                                    <input class="form_field font10 time_field" id="repairStartTime" type="text" name="repairStartTime" value="<cfoutput>#variables.repairStartTime#</cfoutput>" />
								</div>
							</td>
							<td class="column">
								<div class="formField">
									<label class="font10" id="repair_comp_label">&nbsp;REPAIR COMP:</label> 
                                    <input class="form_field font10 calendar_field1" type="text" id="repairCompDate" name="repairCompDate" value="<cfif StructKeyExists(form, 'repairCompDate')><cfoutput>#encodeForHTML(trim(form.repairCompDate))#</cfoutput></cfif>" onchange="RepairComp()"  readonly="readonly" />
                                    <input class="form_field font10 time_field" id="repairCompTime" type="text" name="repairCompTime" value="<cfif StructKeyExists(form, 'repairCompTime')><cfoutput>#encodeForHTML(trim(form.repairCompTime))#</cfoutput></cfif>" />
								</div>
							</td>
						</tr>
					</tbody>
						...
						<tr>
							<td class="column">
                        	    <div class="formField">
                                    ...
                                    <input type="hidden" id="nextPmiId" name="nextPmiId" value="<cfif StructKeyExists(form, 'nextPmiId')><cfoutput>#encodeForHTML(trim(form.nextPmiId))#</cfoutput></cfif>" />
                                    <input class="form_field font10" id="nextPmi" type="text" name="nextPmi" value="<cfif StructKeyExists(form, 'nextPmi')><cfoutput>#encodeForHTML(trim(form.nextPmi))#</cfoutput></cfif>" readonly="readonly" style="min-width: 50%;" />
							...
							<td>		
                                <div class="formField" id="nPmiDate" style="display:none">
                                    ...
                                    <input class="form_field font10 calendar_field" id="nextPmiDate" type="text" name="nextPmiDate" value="<cfif StructKeyExists(form, 'nextPmiDate')><cfoutput>#encodeForHTML(trim(form.nextPmiDate))#</cfoutput></cfif>" readonly="readonly" />
                                </div>
								<div class="formField" id="nPmiEtm" style="display:none">
                                    <label class="font10" id="next_pmi_etm_label"><span class="font10 required_field"></span>NEXT PMI CPOT:</label>
                                    <input class="form_field font10" id="nextPmiEtm" type="text" name="nextPmiEtm" value="<cfif StructKeyExists(form, 'nextPmiEtm')><cfoutput>#encodeForHTML(trim(form.nextPmiEtm))#</cfoutput></cfif>" />
						...
						<tr>
							<td class="column">
                                <div class="formField">
                                    ...
                                    <input type="hidden" id="tctoId" name="tctoId" value="<cfif StructKeyExists(form, 'tctoId')><cfoutput>#encodeForHTML(trim(form.tctoId))#</cfoutput></cfif>" />
                                    <input type="hidden" id="ctTctoId" name="ctTctoId" value="<cfif StructKeyExists(form, 'ctTctoId')><cfoutput>#encodeForHTML(trim(form.ctTctoId))#</cfoutput></cfif>" />
                                    <input class="form_field font10 readonly" id="tctoNo" type="text" name="tctoNo" value="<cfif StructKeyExists(form, 'tctoNo')><cfoutput>#encodeForHTML(trim(form.tctoNo))#</cfoutput></cfif>" readonly="readonly" style="min-width: 70%;" />
                            ...
                            <td class="column">
                                <div class="formField">
                                    ...
                                    <input class="form_field font10 calendar_field" id="effDate" type="text" name="effDate" value="<cfif StructKeyExists(form, 'effDate')><cfoutput>#encodeForHTML(trim(form.effDate))#</cfoutput></cfif>" readonly="readonly" />
                                </div>
                            </td>
                            <td class="column">
                                <div class="formField">
                                    <label class="font10" id="tcto_comp_label">COMPLETED DATE:</label>
                                    <input class="form_field font10 calendar_field" id="tctoCompDate" type="text" name="tctoCompDate" value="<cfif StructKeyExists(form, 'tctoCompDate')><cfoutput>#encodeForHTML(trim(form.tctoCompDate))#</cfoutput></cfif>" readonly="readonly" />
                                </div>
                            </td>
						</tr>
					</tbody>
						...
						<tr>
							<td class="column" colspan="3">
                                <div class="formField">
                                    ...
                                    <input class="form_field font10 sraNoun" id="sraNoun" type="text" name="sraNoun" value="<cfif StructKeyExists(form, 'sraNoun')><cfoutput>#encodeForHTML(trim(form.sraNoun))#</cfoutput></cfif>" readonly="readonly" size="50" />
						...
						<tr>
                            <td class="column">
                                <div class="formField">
                                    ...
                                    <input class="sraId" type="hidden" id="sraAssetId" name="sraAssetId" value="<cfif StructKeyExists(form, 'sraAssetId')><cfoutput>#encodeForHTML(trim(form.sraAssetId))#</cfoutput></cfif>" />
                                    <input class="form_field font10 sraSerno" id="sraSerno" type="text" name="sraSerno" value="<cfif StructKeyExists(form, 'sraSerno')><cfoutput>#encodeForHTML(trim(form.sraSerno))#</cfoutput></cfif>" readonly="readonly" />
                                </div>
                            </td>
                            <td class="column">
                                <div class="formField">
                                    <input type="hidden" id="sraPartnoId" name="sraPartnoId" value="<cfif StructKeyExists(form, 'sraPartnoId')><cfoutput>#encodeForHTML(trim(form.sraPartnoId))#</cfoutput></cfif>" />
									<label class="font10" id="partno_label">PART NO:</label> 
									<input class="form_field font10 sraPartno" id="sraPartno" type="text" name="sraPartno" value="<cfif StructKeyExists(form, 'sraPartno')><cfoutput>#encodeForHTML(trim(form.sraPartno))#</cfoutput></cfif>" readonly="readonly" />
                                    <a href="<cfoutput>#application.rootpath#</cfoutput>/dialogs/lookupPartNoDialog.cfm" class="lookupPartNo" id="luPartNo" title="PART NO" disabled="true"><img src="<cfoutput>#application.rootpath#</cfoutput>/common/images/lookup.png" /></a>
                                </div>
                            </td>
                            <td class="column">
                                <div class="formField">
                                    <label class="font10" id="nsn_label">NSN:</label> 
                                    <input class="form_field font10 sraNsn" id="sraNsn" type="text" name="sraNsn" value="<cfif StructKeyExists(form, 'sraNsn')><cfoutput>#encodeForHTML(trim(form.sraNsn))#</cfoutput></cfif>" readonly="readonly" />
                                </div>
                            </td>
						</tr>
					</tbody>
                        ...
                        <tr>
                            <td class="column remove" style="display:none">
                                <div class="formField">
                                    ...
                                    <input class="form_field font10 sraNoun" id="remSraNoun" type="text" name="remSraNoun" value="<cfif StructKeyExists(form, 'remSraNoun')><cfoutput>#encodeForHTML(trim(form.remSraNoun))#</cfoutput></cfif>" readonly="readonly" size="50" />
                                ...
                                <div class="formField">
                                    ...
                                    <input class="sraId" type="hidden" id="remSraAssetId" name="remSraAssetId" value="<cfif StructKeyExists(form, 'remSraAssetId')><cfoutput>#encodeForHTML(trim(form.remSraAssetId))#</cfoutput></cfif>" />
                                    <input class="form_field font10 sraSerno" id="remSraSerno" type="text" name="remSraSerno" value="<cfif StructKeyExists(form, 'remSraSerno')><cfoutput>#encodeForHTML(trim(form.remSraSerno))#</cfoutput></cfif>" readonly="readonly" />
                                    
                                    <label class="font10" id="is_pqdr_label">&nbsp;IS PQDR:</label>
                                    <select class="select_field font10" id="isPqdr" name="isPqdr" <cfif StructKeyExists(form, "isPqdr") AND form.isPqdr EQ "Y">disabled</cfif>>
	                                ...
	                                <span id="dr_num_reg">
	                                	...
	                                	<input class="form_field required_form_field font10 drNum" id="drNum" type="text" name="drNum" value="<cfif StructKeyExists(form, 'drNum')><cfoutput>#encodeForHTML(trim(form.drNum))#</cfoutput></cfif>" <cfif StructKeyExists(form, "isPqdr") AND form.isPqdr EQ "Y">disabled</cfif> />
                                    </span>
                                    
                                </div>
                                <div class="formField">
                                    <label class="font10" id="rem_partno_label">&nbsp;REMOVE PART NO:</label> 
                                    <input class="form_field font10 sraPartno" id="remSraPartno" type="text" name="remSraPartno" value="<cfif StructKeyExists(form, 'remSraPartno')><cfoutput>#encodeForHTML(trim(form.remSraPartno))#</cfoutput></cfif>" readonly="readonly" />
                                </div>
                                <div class="formField">
                                    <label class="font10" id="rem_nsn_label">&nbsp;REMOVE NSN:</label> 
                                    <input class="form_field font10 sraNsn" id="remSraNsn" type="text" name="remSraNsn" value="<cfif StructKeyExists(form, 'remSraNsn')><cfoutput>#encodeForHTML(trim(form.remSraNsn))#</cfoutput></cfif>" readonly="readonly" />
                                </div>
                            </td>
                            <td class="column install" style="display:none">
                                <div class="formField">
                                     <label class="font10" id="ins_noun_label">&nbsp;INSTALL SRA NOUN:</label> 
                                    <input class="form_field font10 sraNoun" id="insSraNoun" type="text" name="insSraNoun" value="<cfif StructKeyExists(form, 'insSraNoun')><cfoutput>#encodeForHTML(trim(form.insSraNoun))#</cfoutput></cfif>" readonly="readonly" size="50" />
                                ...
                                <div class="formField">
                                    ...
                                    <input type="hidden" id="insSraAssetId" name="insSraAssetId" value="<cfif StructKeyExists(form, 'insSraAssetId')><cfoutput>#encodeForHTML(trim(form.insSraAssetId))#</cfoutput></cfif>" />
                                    <input class="form_field font10" id="insSraSerno" type="text" name="insSraSerno" value="<cfif StructKeyExists(form, 'insSraSerno')><cfoutput>#encodeForHTML(trim(form.insSraSerno))#</cfoutput></cfif>" readonly="readonly" />
                                ...
                                <div class="formField">
                                    ...
                                    <input class="form_field font10" id="insSraPartno" type="text" name="insSraPartno" value="<cfif StructKeyExists(form, 'insSraPartno')><cfoutput>#encodeForHTML(trim(form.insSraPartno))#</cfoutput></cfif>" readonly="readonly" />
                                </div>
                                <div class="formField">
                                    <label class="font10" id="ins_nsn_label">&nbsp;INSTALL NSN:</label> 
                                    <input class="form_field font10" id="insSraNsn" type="text" name="insSraNsn" value="<cfif StructKeyExists(form, 'insSraNsn')><cfoutput>#encodeForHTML(trim(form.insSraNsn))#</cfoutput></cfif>" readonly="readonly" />
                                </div>
                            </td>
                        </tr>
                    </tbody>
                </table>				
				<table class="two_column_table" cellpadding="0" cellspacing="0" id="laborStart" style="display:none">
					<tbody>
						<tr>
                            <td class="column">
                                <div class="formField">
                                    <label class="font10" id="labor_start_label">&nbsp;LABOR START:</label> 
                                    <input class="form_field font10 calendar_field" type="text" id="laborStartDate" name="laborStartDate" value="<cfif StructKeyExists(form, 'laborStartDate')><cfoutput>#encodeForHTML(trim(form.laborStartDate))#</cfoutput></cfif>"  readonly="readonly" />
                                    <input class="form_field font10 time_field" id="laborStartTime" type="text" name="laborStartTime" value="<cfif StructKeyExists(form, 'laborStartTime')><cfoutput>#encodeForHTML(trim(form.laborStartTime))#</cfoutput></cfif>" />
                                </div>
                            </td>
                            <td class="column">
                                <!---<div class="formField">
                                    <label class="font10" id="crew_chief_label">CREW CHIEF:</label> 
                                    <input class="form_field font10" id="crewChief" type="text" name="crewChief" value="<cfif StructKeyExists(form, 'crewChief')><cfoutput>#encodeForHTML(trim(form.crewChief))#</cfoutput></cfif>" />
                                </div>--->
                            </td>
						</tr>
						<tr>
                            <td class="column">
                                <div class="formField">
                                    ...
                                    <input class="form_field font10 calendar_field" type="text" id="laborCompDate" name="laborCompDate" value="<cfif StructKeyExists(form, 'laborCompDate')><cfoutput>#encodeForHTML(trim(form.laborCompDate))#</cfoutput></cfif>"  readonly="readonly" />
                                    <input class="form_field font10 time_field" id="laborCompTime" type="text" name="laborCompTime" value="<cfif StructKeyExists(form, 'laborCompTime')><cfoutput>#encodeForHTML(trim(form.laborCompTime))#</cfoutput></cfif>" />
                                </div>
                            </td>
                            <td class="column">
                                <div class="formField">
                                    <label class="font10" id="crew_size_label">CREW SIZE:</label> 
                                    <input class="form_field font10" id="crewSize" type="text" name="crewSize" value="<cfif StructKeyExists(form, 'crewSize')><cfoutput>#encodeForHTML(trim(form.crewSize))#</cfoutput></cfif>" />
                                </div>
                            </td>
						</tr>
					</tbody>
                        ...
                        <tr>
                            <td>
                                <div class="formField">
                                    ...
                                    <textarea class="text_area_field font10 touppercase" id="correctiveAction" name="correctiveAction" rows="4" ><cfif StructKeyExists(form, 'correctiveAction')><cfoutput>#encodeForHTML(trim(form.correctiveAction))#</cfoutput></cfif></textarea>
                                </div>
                            </td>
                        </tr>
                        <tr>
						             ...
						             <table class="globalTable" id="repairTable">
						                   ...
						                   <cfloop query="rc.qLaborBitPc">    
						                        <tr class="<cfif rc.qLaborBitPc.currentRow mod 2> odd <cfelse> even </cfif>">
					                            	<td class="edit editIcon"><a href="encodeForHTML(index.cfm?action=update.bitPc&labor_bit_id=#rc.qLaborBitPc.ENCRYPTED_LABOR_BIT_ID#&eventRepair=<cfif StructKeyExists(form, 'eventRepair')><cfoutput>#encodeForHTML(trim(form.eventRepair))#</cfoutput></cfif>)"></a></td>
						                            <td>#encodeForHTML(trim(BIT_PARTNO))#</td>
						                            <td>#encodeForHTML(trim(BIT_NAME))#</td>
						                            <td>#encodeForHTML(trim(BIT_QTY))#</td>
						                            <td class="delete deleteIcon "><a href="index.cfm?action=delete.bitPc&labor_bit_id=#rc.qLaborBitPc.ENCRYPTED_LABOR_BIT_ID#&eventRepair=<cfif StructKeyExists(form, 'eventRepair')><cfoutput>#encodeForHTML(trim(form.eventRepair))#</cfoutput></cfif>"></a></td>
						                        </tr>      
						                   </cfloop>
						                   </cfoutput>
						                   </tbody>
                        ...
                        <tr>
                            <td>
                                <div class="button_container">
                                    ...
                                    <input type="submit" class="input_buttons font10" id="btnInsert" name="btnInsert" value="INSERT" onclick="setMethod('doAction',this);setAction('insert.eventDetail',this);" />
