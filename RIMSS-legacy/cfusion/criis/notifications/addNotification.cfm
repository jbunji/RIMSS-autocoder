...
<RIMSS:layout section="notifications" subsection="#APPLICATION.sessionManager.getSubsection()#">
	...
	<div class="headerContent" >
        <div class="headerTitle">Add Notification</div>
    </div>
	
	<div class="font12 mainContent">
        <form id="addNotification" name="addNotification" method="post" action="index.cfm">
            <cfoutput><input type="hidden" class="noreset" readonly="readonly" id="msgId" name="msgId" <cfif StructKeyExists(form,'msgId')>value="#HtmlEditFormat(trim(form.msgId))#"</cfif> /></cfoutput>
                                            ...
                                            <select name="programs" id="programs" >
                                                ...
                                                <cfif isDefined("qPrograms") and isQuery(qPrograms)>
                                                    <cfloop query="qPrograms">
                                                        <option <cfif Structkeyexists(form,"programs") and UCASE(TRIM(form.programs)) eq UCASE(TRIM(CODE_ID))>selected="selected"</cfif>  value="#HTMLEditFormat(CODE_ID)#">#HTMLEditFormat(UCASE(TRIM(CODE_VALUE))#</option>
                                                    </cfloop>
                                                </cfif>
                            ...
                            <td class="column" style="text-align:center">
                                <div class="columnContent">
                                    ...
                                    <div class="formField">
                                        ...
                                        <cfoutput> 
                                        <input class="form_field calendar_field font10 touppercase" readOnly="readOnly" id="startDate" type="text" name="startDate" <cfif StructKeyExists(form,'startDate')>value="#HTMLEditFormat(trim(form.startDate))#"</cfif> readonly="readonly" />
                                        </cfoutput>
                                        <span style="padding:25px">
                                        <label class="font10" id="stop_date_label">Stop Date:</label>
                                        <cfoutput> 
                                        <input class="form_field calendar_field font10 touppercase" readOnly="readOnly" id="stopDate" type="text" name="stopDate" <cfif StructKeyExists(form,'stopDate')>value="#HTMLEditFormat(trim(form.stopDate))#"</cfif> readonly="readonly" />
                                        </cfoutput>
                                        </span>
						    ...
						    <div class="columnContent">
	                            <div class="formField">
	                                ...
	                                <cfoutput>
	                                   ...
	                                   <textarea class="text_area_field font10 touppercase" id="notification" name="notification" rows="4" ><cfif StructKeyExists(form, 'notification')><cfoutput>#HTMLEditFormat(trim(form.notification))#</cfoutput></cfif></textarea>
	                                </cfoutput>
	                            </div>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td colspan="3">
                            <div class="button_container">
                                 <input type="submit" name="btnAdd" value="INSERT" onclick="setAction('insert.notification',this);setMethod('doAction',this);" >
