...
component  displayname="MaintenanceBO" hint="Maintenance Business Object" accessors="true" {
    ...
    /* Create Event */
    public Event function createEvent(required Event event, required CfgMeters cfgMeters, required MeterHist meterHist) {
            ...
            try {
                ...
                if(arguments.removedPart.getAssetId() NEQ ""){
                    ...
                    if (local.part.getLocIdr() NEQ ""){
                		...
                		//local.maintenanceController.insertDepotEvent(local.removedAsset.getAssetId(), local.part.getLocIdr(), arguments.repair); 
   ...
   /* public any function deleteCfgMeter(required assetId, required eventId){
    ...
    public any function acknowledgePartOrder(required any orderId) {
    	var sruOrderService = application.objectFactory.create("SruOrderService");
    ...
    public any function shipPartOrder(required  assetId, required  shipper, required  tcn, required shipDate) {
    	var assetService = application.objectFactory.create("AssetService");
