		...
		<table class="three_column_table" cellpadding="0px" cellspacing="0px" style="">
			...
			<tr>
				<td class="column button_container" colspan="3" style="text-align:center">
					...
					<input type="submit" class="removeSRA admin" name="btnDelete" id="btnDelete" value="REMOVE"> 
					            ...
					            <div class="font10">
					             <table class="globalTable" id="sraTable">
									...
									<tr class="<cfif currentrow mod 2>odd<cfelse>even</cfif>">
										...
										<td class="edit"><a href="index.cfm?action=edit.configuration.sub&assetid=#URLEncodedFormat(rc.util.encryptId(asset_id))#">#encodeForHTML(trim(SERNO))#</a></td>
