                            ...
                            <td class="column">
                                <div class="columnContent">
                                    ...
                                    <div class="formField">
			                            ...
			                            <input class="form_field font10 calendar_field" onfocus="maintCompDateOnChange();" id="maintCompDate" type="text" name="maintCompDate" value="<cfif StructKeyExists(form, 'maintCompDate')><cfoutput>#encodeForHTML(trim(form.maintCompDate))#</cfoutput></cfif>" readonly="readonly" />
