			...
			<cfif QoQSearch.recordcount GT 0>
				   <cfoutput query="QoQSearch"> 
				        <tr class="<cfif currentRow mod 2> odd <cfelse> even </cfif>">
							...
							<td>#DateFormat(encodeForHTML(trim(start_job)),"dd-mmm-yyyy")#</td>
							<cfif Structkeyexists(form,"searchCriteria") and form.searchCriteria NEQ "">
							...
							<td class="delete deleteIcon admin"><a href="index.cfm?action=delete.maintenance&eventJob=#encodeForURL(encrypted_eventid)#&page=pmi"></a></td>
                        </tr>
