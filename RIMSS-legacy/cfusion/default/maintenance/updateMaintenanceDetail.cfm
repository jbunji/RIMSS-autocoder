					      			...
					      			<tr>
										...
										<td>&nbsp;
											<label class="font10">
												...
												<a target="_blank" href="#application.rootpath#/RIMSS/#application.sessionManager.getUserName()#/#rc.qAttachments.name#"> #IIF(rc.qAttachments.name NEQ "", DE('#rc.qAttachments.name#'), DE('#rc.qAttachments.attId#'))# - View</a>
											</label>
										</td>
                        ...
                        <tr>
                            ...
                            <td class="column install" style="display:none">
                                <div class="formField">
                                    ...
                                    <input class="form_field font10 sraNoun" id="insSraNoun" type="text" name="insSraNoun" value="<cfif StructKeyExists(form, 'remSraNoun')><cfoutput>#HTMLEditFormat(trim(form.remSraNoun))#</cfoutput></cfif>" readonly="readonly" size="50" />
