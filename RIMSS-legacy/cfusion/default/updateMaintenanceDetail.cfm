...
<RIMMS:layout layout="default">
    ...
    <script type="text/javascript" src="<cfoutput>#application.rootpath#</cfoutput>/default/layout/js/maintenance.js"></script>
    ...
    <div class="font12 mainContent">
        <cfform id="updateMaintenance" name="updateMaintenance" method="post" action="index.cfm" enctype="multipart/form-data">
            ...
            <input type="hidden" id="partno" name="partno" value="<cfif StructKeyExists(form, 'nhaPartno')><cfoutput>#HTMLEditFormat(trim(form.partno))#</cfoutput><cfelse>02501000-1</cfif>" />
				...
				<table class="one_column_table" cellpadding="0px" cellspacing="0px">
					<tbody>
							<cfoutput query="rc.qAttachments">    
					      			<tr>
					         			<!---<td>&nbsp;<label class="font10"><a href="downloader.cfm?fileName=#rc.qAttachments.name#"> #IIF(rc.qAttachments.name NEQ "", DE('#rc.qAttachments.name#'), DE('#rc.qAttachments.attId#'))# - View</a></label></td>--->
										<td>&nbsp;
											<label class="font10">
												...
												<a target="_blank" href="#application.rootpath#/#application.sessionManager.getUserName()#/#rc.qAttachments.name#"> #IIF(rc.qAttachments.name NEQ "", DE('#rc.qAttachments.name#'), DE('#rc.qAttachments.attId#'))# - View</a>
											</label>
										</td>
                        ...
                        <tr>
                            ...
                            <td class="column install" style="display:none">
                                <div class="formField">
                                    ...
                                    <input class="form_field font10" id="insSraNoun" type="text" name="insSraNoun" value="<cfif StructKeyExists(form, 'insSraNoun')><cfoutput>#HTMLEditFormat(trim(form.insSraNoun))#</cfoutput></cfif>" readonly="readonly" size="50" />
                                    <a href="<cfoutput>#application.rootpath#</cfoutput>/dialogs/lookupSRANounsDialog.cfm" class="lookup luInsSRA" id="lookup_sra_noun_ref" title="SRA"><img id="lookup_img" src="<cfoutput>#application.rootpath#</cfoutput>/common/images/lookup.png" /></a>
                                </div>
                                <div class="formField">
					...
					<tbody>
						    <cfset loopcntr = 1>
						 	...
						 	<cfoutput query="rc.qTestFailed"> 
							 	   ...
							 	   <td align="right" >&nbsp;<label id="test_fail" class="font10"><input type="text" readonly="true" name="testFailId#currentRow#" id="testFailId#currentRow#" value="#qTestFailed.fail_value[currentRow]#"></label></td>
								   <td class="deleteIcon admin" onclick="deleteClick(#currentRow#, #qTestFailed.test_Fail_Id[currentRow]#)"></td>
								   <cfif loopcntr EQ 4>
								   		</tr>	
					      				<tr>
								   </cfif>
						             ...
						             <table class="globalTable" id="repairTable">
						                   ...
						                   <cfloop query="rc.qLaborBitPc">    
						                        <tr class="<cfif rc.qLaborBitPc.currentRow mod 2> odd <cfelse> even </cfif>">
						                            ...
						                            <td class="delete deleteIcon admin"><a href="index.cfm?action=delete.bitPc&labor_bit_id=#rc.qLaborBitPc.ENCRYPTED_LABOR_BIT_ID#&eventRepair=<cfif StructKeyExists(form, 'eventRepair')><cfoutput>#HTMLEditFormat(trim(form.eventRepair))#</cfoutput></cfif>"></a></td>
						                        </tr>      
						                   </cfloop>
						                   </cfoutput>
						                   </tbody>
