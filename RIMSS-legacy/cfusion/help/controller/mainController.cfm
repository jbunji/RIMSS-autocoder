            ...
            try{
                ...
                switch(lcase(trim(ARGUMENTS.action))){
                    ...
                    case 'create.maintenance.detail': {
                        ...
                        local.maintenanceController.getRepairSeq(form.eventId);
                    ...
                    case 'search.pmi': {                    	
                        ...
                        local.maintController= new maintenanceController();
                        local.maintController.searchPmi(form.searchCriteria);                    	
                    }
                ...
                switch(lcase(trim(ARGUMENTS.action))){
                    ...
                    case 'list.sorties':{
                        ...
                        if(len(trim(local.sortieCriteria))){
                            ...
                            redirect('../sorties/sortieSearch.cfm',true);	
                        }   	
                    }
                    ...
                    case 'email.help': {
                    	...
                    	local.helpController=new helpController();
                    	local.helpController.sendEmail(Duplicate(Form));
                    }
