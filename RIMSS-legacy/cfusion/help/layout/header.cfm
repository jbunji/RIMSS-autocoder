...
<cfsilent>
    ...
    <cfif (IsDefined("userModel")) >
		<cfset ATTRIBUTES.showSpares = application.sessionManager.userHasPermission("PCS_ACTTS_SPARES")/>
		<!--- Sorties check --->
...
<html>
	<head>
        ...
        <link href="#programPath#/layout/css/default.css" rel="stylesheet" type="text/css" />
        ...
        <link href="#programPath#/layout/css/content.css" rel="stylesheet" type="text/css" />
        <link href="#programPath#/layout/css/application.css" rel="stylesheet" type="text/css" />
        <link href="#programPath#/layout/css/ui.datepicker.css" rel="stylesheet" type="text/css" />
								...
								<div class="clearfix">
									...
									<div id="skin_header_right">
										...
										<div id="skin_header_info">
										     <!--Location: Robisns AFB Julian: -->#UCASE(TRIM(DateFormat(Now(),"dd-mmm-yyyy")))#
										</div>
                                        ...
                                        <cfif isDefined("programPath") and len(trim(programPath))>
                                            <ul id="menulist">
                                                <cfif showMaintenance>
                                                  <li id="menuMaint"><a href="<cfoutput>#programPath#</cfoutput>/maintenance/backlog.cfm">MAINTENANCE</a></li>
                                                </cfif>
                                                <cfif showConfig>
                                                  <li id="menuConfig"><a href="<cfoutput>#programPath#</cfoutput>/configuration/configuration.cfm">CONFIGURATION</a></li>
                                                </cfif>
                                                <cfif showReports>
                                                  <li id="menuReports"><a href="/ReportsGen2/RIMSS/index.cfm?pgm=<cfoutput>#programInSession#</cfoutput>">REPORTS</a></li>
                                                </cfif>
                                                <cfif false>
                                                  <li id="menuSortie"><a href="<cfoutput>#programPath#</cfoutput>/sortie/sortieSearch.cfm">SORTIES</a></li>
                                                </cfif>
												<cfif showSpares>
                                                  <li id="menuSpares"><a href="<cfoutput>#programPath#</cfoutput>/spares/spares.cfm">SPARES</a></li>
                                                </cfif>
                                                <cfif ATTRIBUTES.showAdmin>
                                                  <li id="menuAdmin"><a href="<cfoutput></cfoutput>/RIMSS/admin/adhoc/index.cfm">ADMIN</a></li>
                                                </cfif>
                                            </ul>
                                        </cfif>
                                    </div>
