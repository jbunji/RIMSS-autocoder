				...
				<tr>
					<td>
						 <div id="maintenance_menu_buttons">
					        ...
					        <form name="maintenance_menu_form" method="post" action="#application.rootPath#/#ATTRIBUTES.layout#/configuration/index.cfm">
					            ...
					            <input type="text" alt="Search Configuration" title="Search Configuration" name="configurationCriteria" id="configurationCriteria" <cfif Structkeyexists(form,"configurationCriteria")>value="#encodeForHTML(form.configurationCriteria)#"</cfif>/>
					...
					<td>
						...
						<div class="exportOptions">
							<cfoutput>
							<ul >
			                    <li class="noLabel" id="printLink"><a href="#application.rootPath#/#ATTRIBUTES.layout#/configuration/index.cfm?action=export.config&exportType=print" target="_blank"></a></li>
			                    <li id="pdfLink"><a href="#application.rootPath#/#ATTRIBUTES.layout#/configuration/index.cfm?action=export.config&exportType=pdf">Export to PDF </a></li>
			                    <li id="excelLink"><a href="#application.rootPath#/#ATTRIBUTES.layout#/configuration/index.cfm?action=export.config&exportType=excel">Export to Excel</a></li>
			                </ul>
							</cfoutput>
						</div>
						</cfif>
