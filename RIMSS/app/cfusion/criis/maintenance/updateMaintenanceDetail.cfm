                        ...
                        <tr>
                            <td>
                                <div class="button_container">
                                    ...
                                    <input type="submit" class="input_buttons font10" id="btnInsert" name="btnInsert" value="SUBMIT" onclick="setMethod('doAction',this);setFailedTests();setAction('update.eventDetail',this);" />
