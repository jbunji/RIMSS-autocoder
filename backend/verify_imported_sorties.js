...
async function main() {
  ...
  importedSorties.forEach((sortie, index) => {
    ...
    console.log(`  Asset: ${sortie.asset.serno} (Tail: ${sortie.asset.tail_no || 'N/A'})`);
    console.log(`  Program: ${sortie.asset.part?.program || 'N/A'}`);
  ...
  console.log(`  Sortie 1 - Serial: ${sortie1?.asset.serno === 'CRIIS-001' ? 'PASS ✓' : 'FAIL ✗'}`);
  ...
  console.log(`  Sortie 2 - Serial: ${sortie2?.asset.serno === 'CRIIS-002' ? 'PASS ✓' : 'FAIL ✗'}`);
