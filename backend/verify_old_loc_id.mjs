...
async function verifyColumn() {
  try {
    ...
    console.log('\n✓ Feature #413 Step 1: PASSED - old_loc_id column exists');
    if (locationsWithOldIdCount > 0) {
      console.log('✓ Feature #413 Step 2: PASSED - Legacy OLD_LOC_ID values imported correctly');
    } else {
      console.log('⚠ Feature #413 Step 2: INCOMPLETE - Need to import legacy data');
    }
