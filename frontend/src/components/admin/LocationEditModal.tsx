...
export default function LocationEditModal({ isOpen, onClose, location, onSuccess }: LocationEditModalProps) {
  ...
  useEffect(() => {
    if (location) {
      setFormData({
        ...
        majcom_cd: location.majcom_cd || '',
        site_cd: location.site_cd || '',
        unit_cd: location.unit_cd || '',
        squad_cd: location.squad_cd || '',
                  ...
                  <div className="mt-3 w-full text-center sm:mt-0 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Update location details. LOC_ID cannot be changed.
                      </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="mt-6 space-y-6">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          disabled
                          className="mt-1 block w-full rounded-md border-gray-300 bg-gray-100 text-gray-500 shadow-sm cursor-not-allowed sm:text-sm"
                        />
                      </div>
