      ...
      {showEditModal && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-lg">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-medium text-gray-900">Edit PMI Schedule</h3>
                <button
                  onClick={() => setShowEditModal(false)}
                  className="text-gray-400 hover:text-gray-500"
                >
              ...
              <div className="bg-gray-50 rounded-lg p-3 mb-4">
                <p className="text-sm font-medium text-gray-900">{pmi.asset_name}</p>
                <p className="text-sm text-gray-500">Serial: {pmi.asset_sn}</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                {/* WUC Code */}
                <div>
                  <label htmlFor="wuc_cd" className="block text-sm font-medium text-gray-700 mb-1">
                    WUC Code
                  </label>
                  <input
                    type="text"
              ...
              <div className="mt-6 flex justify-end space-x-3">
                ...
                <button
                  ...
                  disabled={editing || !editPmiType || !editNextDueDate}
